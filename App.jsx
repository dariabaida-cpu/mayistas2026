              ...
              <>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
                  ...
                  <button onClick={() => setConfirmClear(true)}
                    style={{ padding: "7px 14px", background: "#fff", color: "#c0392b", border: "1px solid #c0392b", borderRadius: 6, cursor: "pointer", fontSize: 13, fontWeight: 600 }}>
                    🗑 Limpiar
                  </button>
                  </div>
                </div>
                ...
                {/* Confirm clear panel */}
                {confirmClear && (
                  <div style={{ background: "#fff3f3", border: "1px solid #e8b4b4", borderRadius: 8, padding: "12px 14px", marginBottom: 14, display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                    <div style={{ flex: 1, fontSize: 13, color: "#c0392b", fontWeight: 600 }}>¿Eliminar todas las ponencias de tu programa?</div>
                    <div style={{ display: "flex", gap: 8 }}>
                      <button onClick={handleClear}
                        style={{ padding: "6px 14px", background: "#c0392b", color: "#fff", border: "none", borderRadius: 6, cursor: "pointer", fontSize: 13, fontWeight: 700 }}>
                        Sí, limpiar
                      </button>
                      <button onClick={() => setConfirmClear(false)}
                        style={{ padding: "6px 12px", background: "transparent", color: "#888", border: "1px solid #ccc", borderRadius: 6, cursor: "pointer", fontSize: 13 }}>
                        Cancelar
                      </button>
                    </div>
                  </div>
